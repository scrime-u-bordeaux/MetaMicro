...
df_mfcc.to_csv("mfcc_features_ta_la_sans_r_main_plus_court.csv", index=False) # mfcc_features_ta_la_r_avant ou mfcc_features_ta_la_r_plus_court ou  mfcc_features_ta_la_r_fonctionne
