...
def lancer_entrainement():
    subprocess.run(["python3", "linux/entrainement_et_meta_micro/main_entrainement.py"])

def tester_metamicro():
    subprocess.run(["python3", "linux/entrainement_et_meta_micro/main_meta_micro.py"])
