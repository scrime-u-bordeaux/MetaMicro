...
# mfcc_2d_before = pca.fit_transform(X)
# label_mapping = {0: "t", 1: "a", 2: "s"}
# colors = {"t": "blue", "a": "green", "s": "red"} 
# block_labels_text = [label_mapping[label] for label in block_labels] 
# class_colors_before = [colors[label] for label in block_labels_text]

# # Affichage des points AVANT undersampling
# plt.figure(figsize=(8, 6))
# plt.scatter(mfcc_2d_before[:, 0], mfcc_2d_before[:, 1], c=class_colors_before, edgecolors='k')
# plt.xlabel("Composante principale 1")
# plt.ylabel("Composante principale 2")
# plt.title("Projection PCA des MFCCs AVANT undersampling")
...
##########################################################################################
# # PCA APRÈS undersampling
# mfcc_2d_balanced = pca.fit_transform(X_balanced)

# block_labels_balanced_text = [label_mapping[label] for label in block_labels_balanced]
# class_colors_balanced = [colors[label] for label in block_labels_balanced_text]

# # Affichage des points APRÈS undersampling
# plt.figure(figsize=(8, 6))
# plt.scatter(mfcc_2d_balanced[:, 0], mfcc_2d_balanced[:, 1], c=class_colors_balanced, edgecolors='k')
# plt.xlabel("Composante principale 1")
# plt.ylabel("Composante principale 2")
# plt.title("Projection PCA des MFCCs APRÈS undersampling")
# handles = [plt.Line2D([0], [0], marker='o', color='w', markerfacecolor=color, markersize=10) for color in colors.values()]
# plt.legend(handles, ["t", "a", "s"], title="Classes")
# plt.grid()
# plt.show()
