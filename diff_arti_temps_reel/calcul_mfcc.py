...
for i, start in enumerate(range(0, len(signal), block_size)): 
    ...
    # # soit pas les prendre, soit donner un nouveau label ou dire que c'est un t
...
# plt.plot(mfcc_matrix[0,:15], label="MFCC 1")  # Affiche le 1er coefficient MFCC
# plt.grid()
# plt.xlabel("Frames")
# plt.ylabel("Amplitude MFCC")
# plt.title("Évolution du 1er coefficient MFCC dans le temps")
# plt.legend()
# plt.show()

# plt.figure(figsize=(12, 4))
# plt.plot(mfcc_matrix[50,:5], label="MFCC 1")  # Affiche le 1er coefficient MFCC
# plt.grid()
# plt.xlabel("Frames")
# plt.ylabel("Amplitude MFCC")
# plt.title("Évolution du 1er coefficient MFCC dans le temps")
...
# plt.figure(figsize=(12, 4))
# plt.plot(mfcc_matrix[85,:5], label="MFCC 1")  # Affiche le 1er coefficient MFCC
# plt.grid()
# plt.xlabel("Frames")
# plt.ylabel("Amplitude MFCC")
# plt.title("Évolution du 1er coefficient MFCC dans le temps")
