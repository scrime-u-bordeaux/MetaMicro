...
# ----------- PIPELINE PRINCIPAL -----------
def start_pipeline():
    threading.Thread(target=full_classification_pipeline).start()

def full_classification_pipeline():
    try:
        ...
        log("Application de l'undersampling par densité…")
...
root = tk.Tk()
root.title("Pipeline Classification et PCA")
...
title_label = tk.Label(
    root,
    text="Pipeline de Classification et PCA",
    font=title_font,
    bg="#2c3e50",
    fg="#ecf0f1",
    pady=10
