...
btn_rms = tk.Button(
    ...
    command=lambda: run_script("mac/entrainement_et_meta_micro/analyse_rms_souffle_fort.py", folder_selected),
    font=button_font,
    bg="#2980b9",
    fg="black",
    activebackground="#3498db",
...
btn_accordeur = tk.Button(
    ...
    command=lambda: run_script("mac/entrainement_et_meta_micro/accordage_voyelle_yaml_affichage.py", folder_selected),
    font=button_font,
    bg="#8e44ad",
    fg="black",
...
btn_respiro = tk.Button(
    ...
    command=lambda: run_script("mac/entrainement_et_meta_micro/main_respiro_yaml_affichage.py", folder_selected),
    font=button_font,
    bg="#16a085",
    fg="black",
