...
knn_model = joblib.load("scripts/ta_la/knn_model_db_sans_r_opt_main_corrige_avant.pkl")  
eigenvectors_thresholded = joblib.load("scripts/ta_la/eigenvectors_thresholded_corrige_avant_tronque.pkl") 
mean_X = joblib.load("scripts/ta_la/mfcc_mean.pkl")
std_X = joblib.load("scripts/ta_la/mfcc_std.pkl")
...
df_ent = pd.read_csv("scripts/ta_la/X_proj_scaled_avec_labels_corrige_avant.csv")
