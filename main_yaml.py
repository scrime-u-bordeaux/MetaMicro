...
param_descriptions = {
    "rms_max": "Valeur maximale du RMS utilisée pour normaliser le volume. A modifier à la main ou avec l'option 'calculer souffle max'",
...
# ----------- FONCTIONS POUR LANCER LES SCRIPTS -----------
...
root = tk.Tk()
root.title("Mise à jour des chemins YAML")
...
title_label = tk.Label(
    root,
    text="Mise à jour des chemins YAML",
    font=title_font,
    bg="#2c3e50",
    fg="#ecf0f1",
    pady=10
...
btn_rms = tk.Button(
    script_frame,
    text="Calculer souffle max",
    command=lambda: run_script("analyse_rms_souffle_fort.py"),
    font=button_font,
    bg="#2980b9",
    fg="black",
    activebackground="#3498db",
...
btn_accordeur = tk.Button(
    ...
    command=lambda: run_script("accordage_voyelle_yaml_affichage.py"),
    font=button_font,
    bg="#8e44ad",
    fg="black",
...
btn_respiro = tk.Button(
    ...
    command=lambda: run_script("main_respiro_yaml_affichage.py"),
    font=button_font,
    bg="#16a085",
    fg="black",
